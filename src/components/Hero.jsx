    ...
    <div className='grid grid-cols-1 gap-4 p-8 px-12 sm:grid-cols-2 mt-20 ' style={{height: '84vh'}}>
        <div className='flex justify-center align-middle m-auto'>
            <div className='align-middle'>
                ...
                <a target="_blank" href="https://drive.google.com/file/d/1pTXINyDTBQHt8MPNRbYWqBKiEvtcyLvF/view?usp=sharing" className='bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded'>
                    View My Resume
                </a>
            </div>
       </div>
